      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
          ...
          <div className="mb-12 lg:mb-0">
            {/* *** MODIFIED: Added text-center here and for the divider *** */}
            <h3 className="text-center text-sm font-semibold text-gray-600 tracking-wide uppercase">
              About
            </h3>
            <h2 className="text-center mt-2 text-3xl font-extrabold text-[#FF5C5C] sm:text-4xl">
              Sri Sai Exim
            </h2>
            {/* The small line and icon divider */}
            {/* *** MODIFIED: Used flex justify-center to center the divider itself *** */}
            <div className="mt-4 flex items-center justify-center"> 
              ...
              <div className="ml-3 w-16 h-1 bg-blue-500 rounded-full"></div>
            </div>
            
            {/* MODIFIED: Added text-center here as well, if you want the paragraph text centered, otherwise remove it */}

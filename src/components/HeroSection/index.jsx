  ...
  <div className="relative h-[60vh] md:h-[90vh] font-poppins" style={{ backgroundColor: PRIMARY_COLOR }}>
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
      ...
      <button
        ...
        className="px-8 py-3 text-lg font-semibold rounded-lg text-white shadow-xl transition duration-300 transform hover:scale-[1.05]"
        style={{ backgroundColor: "#30b6f0ff" }}
        onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#30b6f0ff")} //
